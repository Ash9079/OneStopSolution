...
const ArrowRight = ({ color = "#D4A017", size = 16 }) => (
...
const ShieldIcon = ({ color = "#3A7D6E" }) => (
  <svg width="34" height="34" viewBox="0 0 24 24" fill="none">
    <path d="M12 3l7 3v6c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3z" stroke={color} strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M9 12l2 2 4-4" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const DiamondIcon = ({ color = "#3A7D6E" }) => (
  <svg width="34" height="34" viewBox="0 0 24 24" fill="none">
    <path d="M4 8l4-5h8l4 5-8 12L4 8z" stroke={color} strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M4 8h16M9 3l3 5 3-5M9.5 8L12 20l2.5-12" stroke={color} strokeWidth="1.2" strokeLinejoin="round" />
  </svg>
);
...
const SparkleIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <path d="M12 2l1.8 6.2L20 10l-6.2 1.8L12 18l-1.8-6.2L4 10l6.2-1.8L12 2z" fill="#D4A017" />
  </svg>
);
const QuoteMark = () => (
...
/* =========================================================
   1. HERO — fixed background image, full heading fits
========================================================= */
function Hero() {
  ...
  return (
    <Box
      ...
      <Container maxWidth="xl" sx={{ py: { xs: 8, md: 10 }, px: sidePad }}>
        ...
        <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: { xs: "36px", sm: "48px", md: "68px" }, lineHeight: 1.1 ,color: "#D8DEE7"}}>
          India's Trusted
        </Typography>
        <Typography
          sx={{ fontFamily: serif, fontStyle: "italic", fontWeight: 600, fontSize: { xs: "38px", sm: "50px", md: "72px" }, color: "#E9CB6E", lineHeight: 1.1 }}
        >
          HR &amp; Placement
        </Typography>
        <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: { xs: "36px", sm: "48px", md: "68px" }, lineHeight: 1.1, mb: 3 ,color: "#D8DEE7"}}>
          Partner.
        </Typography>

        <Typography sx={{ fontSize: "18px", color: "#D8DEE7", maxWidth: 620, mb: 4, lineHeight: 1.7 }}>
      ...
      <Box sx={{ borderTop: "1px solid rgba(255,255,255,0.15)", mt: 6, py: 2, overflow: "hidden", whiteSpace: "nowrap" }}>
        <Box
          sx={{
            display: "inline-flex",
            gap: 5,
        ...
        >
          {[...industries, ...industries].map((ind, i) => (
            <Box key={i} sx={{ display: "flex", alignItems: "center", gap: 5 }}>
              <Typography sx={{ fontSize: "13px", letterSpacing: "2px", fontWeight: 600, color: "#B8C0CC" }}>{ind}</Typography>
...
function WhoWeAre() {
  ...
  return (
    <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 }, px: sidePad }}>
      <Box sx={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
        <Box sx={{ flex: "1 1 380px" }}>
          <SectionLabel>WHO WE ARE</SectionLabel>
          <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: { xs: "36px", md: "48px" }, color: "#0A2647", lineHeight: 1.15 }}>
            Comprehensive HR &amp;
          </Typography>
          <Typography sx={{ fontFamily: serif, fontStyle: "italic", fontWeight: 600, fontSize: { xs: "36px", md: "48px" }, color: "#3A7D6E", lineHeight: 1.15, mb: 3 }}>
            workforce solutions
          </Typography>
          <Typography sx={{ fontSize: "16px", color: "#5C6B7A", lineHeight: 1.8, mb: 3, maxWidth: 480 }}>
        ...
        <Box sx={{ flex: "1 1 480px", display: "flex", flexWrap: "wrap" }}>
          {items.map((item) => (
            <Box key={item.title} sx={{ flex: "1 1 45%", pl: 3, py: 2, borderLeft: "2px solid #D4A017", mb: 4, pr: 2 }}>
              <Box sx={{ mb: 2 }}>{item.icon}</Box>
              <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: "21px", color: "#0A2647", mb: 1 }}>{item.title}</Typography>
      ...
      <Container maxWidth="xl" sx={{ px: sidePad }}>
        <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "flex-end", mb: 6, gap: 2 }}>
          <Box>
            ...
            <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: { xs: "34px", md: "48px" }, color: "#0A2647", maxWidth: 640, lineHeight: 1.2 }}>
        ...
        <Box sx={{ display: "flex", flexWrap: "wrap", border: "1px solid #E2E6EB", background: "#fff" }}>
          {services.map((s, i) => (
            <Box
              key={s.title}
              sx={{
            ...
            >
              ...
              <Typography className="service-title" sx={{ fontFamily: serif, fontWeight: 700, fontSize: "23px", color: "#0A2647", mb: 1.5, transition: "color 0.3s ease" }}>
                {s.title}
              </Typography>
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                <Typography className="learn-more" sx={{ fontSize: "12.5px", letterSpacing: "1.5px", fontWeight: 700, color: "#D4A017", transition: "color 0.3s ease" }}>
                  LEARN MORE
                </Typography>
                <ArrowRight size={14} />
              </Box>
...
function WhyChooseUs() {
  ...
  const numSx = { fontFamily: serif, fontWeight: 700, fontSize: { xs: "40px", md: "52px" }, color: "#0A2647" };
  return (
    <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 }, px: sidePad }}>
      <SectionLabel>WHY CHOOSE US</SectionLabel>
      <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: { xs: "34px", md: "48px" }, color: "#0A2647", lineHeight: 1.2 }}>
        Numbers that reflect our
      </Typography>
      <Typography sx={{ fontFamily: serif, fontStyle: "italic", fontWeight: 600, fontSize: { xs: "34px", md: "48px" }, color: "#3A7D6E", mb: 6 }}>
        consistency.
      </Typography>

      <Box sx={{ display: "flex", flexWrap: "wrap", gap: 5, mb: 7 }}>
        <Box sx={{ flex: "1 1 200px" }}>
          <CountStat target={5000} suffix="+" comma sx={numSx} />
          <Typography sx={{ fontSize: "12.5px", letterSpacing: "2px", fontWeight: 600, color: "#8B93A1", mt: 1 }}>CANDIDATES PLACED</Typography>
        </Box>
        <Box sx={{ flex: "1 1 200px" }}>
          <CountStat target={300} suffix="+" sx={numSx} />
          <Typography sx={{ fontSize: "12.5px", letterSpacing: "2px", fontWeight: 600, color: "#8B93A1", mt: 1 }}>CORPORATE CLIENTS</Typography>
        </Box>
        <Box sx={{ flex: "1 1 200px" }}>
          <CountStat target={98} suffix="%" sx={numSx} />
          <Typography sx={{ fontSize: "12.5px", letterSpacing: "2px", fontWeight: 600, color: "#8B93A1", mt: 1 }}>CLIENT SATISFACTION</Typography>
        </Box>
        <Box sx={{ flex: "1 1 200px" }}>
          <CountStat target={40} suffix="+" sx={numSx} />
          <Typography sx={{ fontSize: "12.5px", letterSpacing: "2px", fontWeight: 600, color: "#8B93A1", mt: 1 }}>CITIES SERVICED</Typography>
        </Box>
      </Box>
      ...
      <Box sx={{ display: "flex", flexWrap: "wrap", gap: 3 }}>
        {badges.map((b) => (
          <Box
            key={b}
            sx={{ flex: "1 1 220px", display: "flex", alignItems: "center", gap: 1.5, border: "1px solid #E2E6EB", borderRadius: "8px", px: 3, py: 2.5, boxShadow: "0 2px 6px rgba(10,38,71,0.04)" }}
          >
            <SparkleIcon />
            <Typography sx={{ fontSize: "15px", fontWeight: 600, color: "#0A2647" }}>{b}</Typography>
          </Box>
        ))}
      </Box>
    </Container>
...
const Pill = ({ label, active }) => (
  ...
  >
    {active && <Box sx={{ width: 6, height: 6, background: "#0A2647", transform: "rotate(45deg)" }} />}
    <Typography
  ...
  return (
    <Box sx={{ background: "#0A2647", color: "#fff", py: { xs: 8, md: 12 } }}>
      <Container maxWidth="xl" sx={{ px: sidePad }}>
        <SectionLabel dark>INDUSTRIES WE SERVE</SectionLabel>
        <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: { xs: "30px", md: "46px" }, lineHeight: 1.3, maxWidth: 900, mb: 6 }}>
          From{" "}
...
function Testimonials() {
  ...
  return (
    <Container maxWidth="xl" sx={{ py: { xs: 8, md: 12 }, px: sidePad }}>
      ...
      <Typography sx={{ display: "inline", fontFamily: serif, fontStyle: "italic", fontWeight: 600, fontSize: { xs: "34px", md: "48px" }, color: "#3A7D6E" }}>
        candidates{" "}
      </Typography>
      <Typography sx={{ display: "inline", fontFamily: serif, fontWeight: 700, fontSize: { xs: "34px", md: "48px" }, color: "#0A2647", mb: 6 }}>
        say.
      </Typography>
      ...
      <Box sx={{ display: "flex", flexWrap: "wrap", gap: 4, mt: 6 }}>
        {items.map((t) => (
          <Box
            key={t.name}
            sx={{ flex: { xs: "1 1 100%", sm: "1 1 45%", md: "1 1 30%" }, maxWidth: { md: "32%" }, border: "1px solid #E2E6EB", borderRadius: "8px", p: 4, display: "flex", flexDirection: "column" }}
          >
            ...
            <Box sx={{ borderTop: "1px solid #E2E6EB", pt: 2 }}>
              <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: "17px", color: "#0A2647" }}>{t.name}</Typography>
...
/* =========================================================
   7. GALLERY — 1 big left, 2x2 small right (matches screenshot)
========================================================= */
function Gallery() {
  const big = Home1;
  const small = [
      ...
      <Container maxWidth="xl" sx={{ px: sidePad }}>
        <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "flex-end", mb: 6, gap: 2 }}>
          <Box>
            ...
            <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: { xs: "34px", md: "48px" }, color: "#0A2647" }}>
        ...
        <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2, alignItems: "stretch" }}>
          ...
          <Box sx={{ flex: "1 1 40%", minWidth: 300 }}>
            <Box component="img" src={big} sx={{ width: "100%", height: "100%", minHeight: 520, objectFit: "cover", borderRadius: "4px", display: "block" }} />
          </Box>

          {/* 2x2 small grid right */}
          <Box sx={{ flex: "1 1 55%", minWidth: 300, display: "flex", flexDirection: "column", gap: 2 }}>
            <Box sx={{ display: "flex", gap: 2, flex: 1 }}>
              <Box component="img" src={small[0]} sx={{ flex: 1, height: 250, objectFit: "cover", borderRadius: "4px" }} />
              <Box component="img" src={small[1]} sx={{ flex: 1, height: 250, objectFit: "cover", borderRadius: "4px" }} />
            </Box>
            <Box sx={{ display: "flex", gap: 2, flex: 1 }}>
              <Box component="img" src={small[2]} sx={{ flex: 1, height: 250, objectFit: "cover", borderRadius: "4px" }} />
              <Box component="img" src={small[3]} sx={{ flex: 1, height: 250, objectFit: "cover", borderRadius: "4px" }} />
            </Box>
          </Box>
        </Box>
      </Container>
...
/* =========================================================
   8. FOR EMPLOYERS / FOR CANDIDATES — padded to match rest of page
========================================================= */
function EmployerCandidateCTA() {
  return (
    <Box sx={{ px: sidePad, py: { xs: 5, md: 8 } }}>
      <Box sx={{ display: "flex", flexWrap: "wrap", border: "1px solid #E2E6EB" }}>
        {/* For Employers */}
        <Box sx={{ flex: "1 1 50%", minWidth: 320, background: "#0A2647", color: "#fff", px: { xs: 4, md: 6 }, py: { xs: 6, md: 8 } }}>
          <Typography sx={{ fontSize: "12px", letterSpacing: "3px", fontWeight: 600, color: "#8B93A1", mb: 3 }}>
            FOR EMPLOYERS
          </Typography>
          <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: { xs: "30px", md: "40px" }, lineHeight: 1.2, mb: 3, maxWidth: 480 }}>
            Ready to build your dream team?
          </Typography>
          <Typography sx={{ fontSize: "16px", color: "#C4CBD4", lineHeight: 1.7, mb: 4, maxWidth: 460 }}>
        ...
        {/* For Candidates */}
        <Box sx={{ flex: "1 1 50%", minWidth: 320, background: "#fff", px: { xs: 4, md: 6 }, py: { xs: 6, md: 8 } }}>
          <Typography sx={{ fontSize: "12px", letterSpacing: "3px", fontWeight: 600, color: "#3A7D6E", mb: 3 }}>
            FOR CANDIDATES
          </Typography>
          <Typography sx={{ fontFamily: serif, fontWeight: 700, fontSize: { xs: "30px", md: "40px" }, lineHeight: 1.2, color: "#0A2647", mb: 3, maxWidth: 480 }}>
            Your next role is closer than you think.
          </Typography>
          <Typography sx={{ fontSize: "16px", color: "#5C6B7A", lineHeight: 1.7, mb: 4, maxWidth: 460 }}>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            <PinIcon />
            <Typography sx={{ fontSize: "14.5px", color: "#5C6B7A" }}>Dadar East, Mumbai – 400014</Typography>
          </Box>
        </Box>
      </Box>
    </Box>
